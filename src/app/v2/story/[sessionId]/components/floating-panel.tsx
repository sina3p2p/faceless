...
export function FloatingPanel({
  ...
  return (
    <div
      ref={selfRef}
      className="absolute bg-[#1c1c1f]/96 backdrop-blur-md border border-white/10 rounded-2xl shadow-2xl overflow-hidden"
      style={{ left: pos.x, top: pos.y, width, zIndex }}
      onClick={(e) => e.stopPropagation()}
    >
      <div
        className="flex items-center justify-between px-3 py-2.5 border-b border-white/8 cursor-grab active:cursor-grabbing select-none"
