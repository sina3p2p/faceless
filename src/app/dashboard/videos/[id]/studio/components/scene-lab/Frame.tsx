...
export default function Frame({
    ...
    return (
        <div className="flex flex-col items-center shrink-0 gap-2">
            {imageVariants.map(v => (
                <div key={v.id} className="w-56 rounded-xl border border-white/10 bg-white/[0.02] overflow-hidden">
                    {/* Header */}
                    ...
                    <div className="p-3 space-y-2">
                        ...
                        {frame.imageUrl ? (
                            <div className="relative group">
                                ...
                                <img src={v.url} alt={`Frame ${frameIndex + 1}`} className="rounded-lg w-full max-h-40 object-cover" />
