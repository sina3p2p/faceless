...
export const videoProjects = pgTable("video_projects", {
  ...
  modelSettings: json("model_settings").$type<ModelSettings>().notNull().default({
    storyModel: "anthropic/claude-opus-4.6",
    directorModel: "anthropic/claude-opus-4.6",
    supervisorModel: "anthropic/claude-opus-4.6",
    cinematographerModel: "anthropic/claude-opus-4.6",
    storyboardModel: "anthropic/claude-opus-4.6",
    promptModel: "anthropic/claude-opus-4.6",
    motionModel: "anthropic/claude-opus-4.6",
    imageModel: "anthropic/claude-opus-4.6",
    videoModel: "anthropic/claude-opus-4.6",
  }),
