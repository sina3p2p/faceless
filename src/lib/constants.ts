...
export const VIDEO_MODELS = [
  ...
  { id: "hailuo-02-standard", label: "Hailuo 02 Standard", modelId: "fal-ai/minimax/hailuo-02/standard/image-to-video", description: "Natural motion, budget-friendly (~$0.27/5s)", durations: [6,10] as number[], endFrame: true },
  { id: "hailuo-02-pro", label: "Hailuo 02 Pro", modelId: "fal-ai/minimax/hailuo-02/pro/image-to-video", description: "1080p, great prompt following (~$0.48/5s)", durations: [6,10] as number[], endFrame: true },
