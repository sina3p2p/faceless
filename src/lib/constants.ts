...
export const VIDEO_MODELS = [
  ...
  { id: "grok-imagine", label: "Grok Imagine Video", modelId: "xai/grok-imagine-video/image-to-video", provider: "fal" as const, description: "#1 ranked i2v, fast <15s ($0.07/s → ~$0.35/5s)", durations: [5, 6, 10] as number[], endFrame: false, durationFormat: "string" as const },
  ...
  { id: "veo-31-fast", label: "Veo 3.1 Fast", modelId: "fal-ai/veo3.1/fast/image-to-video", provider: "fal" as const, description: "Google top-tier, 1080p ($0.10/s → ~$0.50/5s)", durations: [4, 5, 6, 7, 8] as number[], endFrame: false, durationFormat: "number" as const },
